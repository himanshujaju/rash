...
# Unit tests for ConcurrentLRUCache
# Run `./concurrent_lru_cache_test.rb` to run these tests

require './concurrent_lru_cache'
...
def FindValidKeyTest()
  cache = ConcurrentLRUCache.new(10)
  key = "key_42"
  value = "value_xyz"
  cache.add(key, value)
...
def AddWithUpdatedAccessTimeTest()
  cache_size = 7
  range = 0...cache_size
  cache = ConcurrentLRUCache.new(cache_size)
  range.each do |i|
